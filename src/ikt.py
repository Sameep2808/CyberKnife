...
if __name__=="__main__":
	...
	A4_5= A.subs({alpha:pi/2, a:0, theta:theta5, d:520.7+523.24}) #1.04394
	...
	pri(Q)
	print(Q)
	T0_w=T0_6.subs({theta1:0,theta2:0,theta3:0,theta4:pi/2,theta5:0,theta6:0})
	T0_w=nsimplify(T0_w,tolerance=1e-3,rational=True)
	print(T0_w)
	T0_w=T0_6.subs({theta1:Q[0,0],theta2:Q[0,1],theta3:Q[0,2],theta4:Q[0,3],theta5:Q[0,4],theta6:Q[0,5]})
	T0_w=nsimplify(T0_w,tolerance=1e-3,rational=True)
	print(T0_w)
